...
namespace RhymeBinder.Models.HelperModels
{
    public class ViewHelper : BaseHelper
    {
        ...
        {   // The intent here is that when the user changes the dispaly
            ...
            viewToUpdate.Descending = savedView.View.Descending ?? false;
            viewToUpdate.ViewName = savedView.View.ViewName;
            viewToUpdate.Default = savedView.View.Default ?? false;
            viewToUpdate.Saved = savedView.View.Saved ?? false;
            viewToUpdate.LastModified = savedView.View.LastModified ?? false;
            viewToUpdate.LastModifiedBy = savedView.View.LastModifiedBy ?? false;
            viewToUpdate.Created = savedView.View.Created ?? false;
            viewToUpdate.CreatedBy = savedView.View.CreatedBy ?? false;
            viewToUpdate.VisionNumber = savedView.View.VisionNumber ?? false;
            viewToUpdate.RevisionStatus = savedView.View.RevisionStatus ?? false;
            viewToUpdate.Groups = savedView.View.Groups ?? false;
            viewToUpdate.WordCount = savedView.View.WordCount ?? false;
            viewToUpdate.CharacterCount = savedView.View.CharacterCount ?? false;
